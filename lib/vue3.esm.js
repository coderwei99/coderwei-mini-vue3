...
function createRenderer(options) {
    ...
    const { createElement: hotCreateElement, patchProp: hotPatchProp, insert: hotInsert, } = options;
...
export { EffectDepend, Fragment, ReactiveFlags, Text, cleanupEffect, convert, createApp, createAppAPI, createComponentInstance, createGetter, createRenderer, createSetter, createTextVNode, createVNode, currentInstance, effect, emit, getCurrentInstance, getShapeFlag, h, hasChanged, initProps, initSlots, inject, isProxy, isReactive, isReadonly, isRef, isShallow, isTracking, mutableHandlers, normalizeChildren, provide, proxyRefs, publicInstanceProxyHandlers, reactive, readonly, readonlyHandlers, ref, remove$1 as remove, renderSlot, setCurrentInstance, setupComponent, shallowReactive, shallowReactiveHandlers, shallowReadonly, shallowReadonlyHandlers, stop, tarckEffect, toRaw, track, trackRefValue, trigger, triggerEffect, unref };
