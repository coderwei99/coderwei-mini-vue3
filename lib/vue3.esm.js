...
export { EffectDepend, Fragment, ReactiveFlags, Text, cleanupEffect, convert, createApp, createComponentInstance, createGetter, createSetter, createTextVNode, createVNode, currentInstance, effect, emit, getCurrentInstance, getShapeFlag, h, hasChanged, initProps, initSlots, inject, isOn, isProxy, isReactive, isReadonly, isRef, isShallow, isTracking, mutableHandlers, normalizeChildren, provide, proxyRefs, publicInstanceProxyHandlers, reactive, readonly, readonlyHandlers, ref, render, renderSlot, setCurrentInstance, setupComponent, shallowReactive, shallowReactiveHandlers, shallowReadonly, shallowReadonlyHandlers, stop, tarckEffect, toRaw, track, trackRefValue, trigger, triggerEffect, unref };
