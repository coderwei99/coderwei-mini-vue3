...
export { EffectDepend, Fragment, ReactiveFlags, Text, cleanupEffect, createApp, createComponentInstance, createGetter, createSetter, createTextVNode, createVNode, effect, emit, getShapeFlag, h, initProps, initSlots, isOn, isProxy, isReactive, isReadonly, isShallow, isTracking, mutableHandlers, normalizeChildren, publicInstanceProxyHandlers, reactive, readonly, readonlyHandlers, render, renderSlot, setupComponent, shallowReactive, shallowReactiveHandlers, shallowReadonly, shallowReadonlyHandlers, stop, tarckEffect, toRaw, track, trigger, triggerEffect };
