...
export { EffectDepend, Fragment, ReactiveFlags, Text, cleanupEffect, createApp, createComponentInstance, createGetter, createSetter, createTextVNode, createVNode, currentInstance, effect, emit, getCurrentInstance, getShapeFlag, h, initProps, initSlots, inject, isOn, isProxy, isReactive, isReadonly, isShallow, isTracking, mutableHandlers, normalizeChildren, provide, publicInstanceProxyHandlers, reactive, readonly, readonlyHandlers, render, renderSlot, setCurrentInstance, setupComponent, shallowReactive, shallowReactiveHandlers, shallowReadonly, shallowReadonlyHandlers, stop, tarckEffect, toRaw, track, trigger, triggerEffect };
