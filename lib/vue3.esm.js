...
export { EffectDepend, Fragment, ReactiveFlags, Text, cleanupEffect, convert, createApp, createAppAPI, createComponentInstance, createGetter, createRenderer, createSetter, createTextVNode, createVNode, currentInstance, effect, emit, getCurrentInstance, getShapeFlag, h, hasChanged, initProps, initSlots, inject, isProxy, isReactive, isReadonly, isRef, isShallow, isTracking, mutableHandlers, nextTick, normalizeChildren, provide, proxyRefs, publicInstanceProxyHandlers, queueJobs, reactive, readonly, readonlyHandlers, ref, remove$1 as remove, renderSlot, setCurrentInstance, setupComponent, shallowReactive, shallowReactiveHandlers, shallowReadonly, shallowReadonlyHandlers, stop, tarckEffect, toRaw, track, trackRefValue, trigger, triggerEffect, unref };
